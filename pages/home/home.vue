...
<script>
	import { getAppindexdataShow } from './server.js'
	export default {
		data() {
			return {
				xmdata: {},
				flData: {
					fqksData: { FQKS: "废弃矿山综合整治", FQKSJD: 87.75 },
					ncmyData: { NCMY: "农村面源污染整治", NCMYJD: 85.5 },
					ntstData: { NTST: "农田生态系统提升工程", NTSTJD: 91 },
					stlsData: { STLS: "水土流失综合治理", STLSJD: 89.5 },
					szybhData: { SZYBH: "水资源保护与综合利用", SZYBHJD: 88.4 },
				}
			};
		},
		async onLoad() {
